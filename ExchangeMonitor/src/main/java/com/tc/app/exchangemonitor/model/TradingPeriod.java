...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "TradingPeriod.findAll", query = "SELECT t FROM TradingPeriod t"), @NamedQuery(name = "TradingPeriod.findByCommktKey", query = "SELECT t FROM TradingPeriod t WHERE t.tradingPeriodPK.commktKey = :commktKey"), @NamedQuery(name = "TradingPeriod.findByTradingPrd", query = "SELECT t FROM TradingPeriod t WHERE t.tradingPeriodPK.tradingPrd = :tradingPrd"), @NamedQuery(name = "TradingPeriod.findByLastTradeDate", query = "SELECT t FROM TradingPeriod t WHERE t.lastTradeDate = :lastTradeDate"), @NamedQuery(name = "TradingPeriod.findByOptExpDate", query = "SELECT t FROM TradingPeriod t WHERE t.optExpDate = :optExpDate"), @NamedQuery(name = "TradingPeriod.findByFirstDelDate", query = "SELECT t FROM TradingPeriod t WHERE t.firstDelDate = :firstDelDate"), @NamedQuery(name = "TradingPeriod.findByLastDelDate", query = "SELECT t FROM TradingPeriod t WHERE t.lastDelDate = :lastDelDate"), @NamedQuery(name = "TradingPeriod.findByFirstIssueDate", query = "SELECT t FROM TradingPeriod t WHERE t.firstIssueDate = :firstIssueDate"), @NamedQuery(name = "TradingPeriod.findByLastIssueDate", query = "SELECT t FROM TradingPeriod t WHERE t.lastIssueDate = :lastIssueDate"), @NamedQuery(name = "TradingPeriod.findByLastQuoteDate", query = "SELECT t FROM TradingPeriod t WHERE t.lastQuoteDate = :lastQuoteDate"), @NamedQuery(name = "TradingPeriod.findByTradingPrdDesc", query = "SELECT t FROM TradingPeriod t WHERE t.tradingPrdDesc = :tradingPrdDesc"), @NamedQuery(name = "TradingPeriod.findByOptEvalMethod", query = "SELECT t FROM TradingPeriod t WHERE t.optEvalMethod = :optEvalMethod"), @NamedQuery(name = "TradingPeriod.findByTransId", query = "SELECT t FROM TradingPeriod t WHERE t.transId = :transId")})
public class TradingPeriod implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof TradingPeriod)){ return false; }
		TradingPeriod other = (TradingPeriod) object;
		if((this.tradingPeriodPK == null && other.tradingPeriodPK != null) || (this.tradingPeriodPK != null && !this.tradingPeriodPK.equals(other.tradingPeriodPK))){ return false; }
		return true;
	}

...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommktSourceRollDate.findAll", query = "SELECT c FROM CommktSourceRollDate c"), @NamedQuery(name = "CommktSourceRollDate.findByCommktKey", query = "SELECT c FROM CommktSourceRollDate c WHERE c.commktSourceRollDatePK.commktKey = :commktKey"), @NamedQuery(name = "CommktSourceRollDate.findByPriceSourceCode", query = "SELECT c FROM CommktSourceRollDate c WHERE c.commktSourceRollDatePK.priceSourceCode = :priceSourceCode"), @NamedQuery(name = "CommktSourceRollDate.findByRollDateRuleNum", query = "SELECT c FROM CommktSourceRollDate c WHERE c.commktSourceRollDatePK.rollDateRuleNum = :rollDateRuleNum"), @NamedQuery(name = "CommktSourceRollDate.findByRollDateDays", query = "SELECT c FROM CommktSourceRollDate c WHERE c.rollDateDays = :rollDateDays"), @NamedQuery(name = "CommktSourceRollDate.findByRollDateBusCalInd", query = "SELECT c FROM CommktSourceRollDate c WHERE c.rollDateBusCalInd = :rollDateBusCalInd"), @NamedQuery(name = "CommktSourceRollDate.findByRollDateOnInd", query = "SELECT c FROM CommktSourceRollDate c WHERE c.rollDateOnInd = :rollDateOnInd"), @NamedQuery(name = "CommktSourceRollDate.findByRollDateEvent", query = "SELECT c FROM CommktSourceRollDate c WHERE c.rollDateEvent = :rollDateEvent"), @NamedQuery(name = "CommktSourceRollDate.findByTransId", query = "SELECT c FROM CommktSourceRollDate c WHERE c.transId = :transId")})
public class CommktSourceRollDate implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommktSourceRollDate)){ return false; }
		CommktSourceRollDate other = (CommktSourceRollDate) object;
		if((this.commktSourceRollDatePK == null && other.commktSourceRollDatePK != null) || (this.commktSourceRollDatePK != null && !this.commktSourceRollDatePK.equals(other.commktSourceRollDatePK))){ return false; }
		return true;
	}

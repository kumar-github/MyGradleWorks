...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommodityMarketFormula.findAll", query = "SELECT c FROM CommodityMarketFormula c"), @NamedQuery(name = "CommodityMarketFormula.findByCommktKey", query = "SELECT c FROM CommodityMarketFormula c WHERE c.commodityMarketFormulaPK.commktKey = :commktKey"), @NamedQuery(name = "CommodityMarketFormula.findByTradingPrd", query = "SELECT c FROM CommodityMarketFormula c WHERE c.commodityMarketFormulaPK.tradingPrd = :tradingPrd"), @NamedQuery(name = "CommodityMarketFormula.findByPriceSourceCode", query = "SELECT c FROM CommodityMarketFormula c WHERE c.commodityMarketFormulaPK.priceSourceCode = :priceSourceCode"), @NamedQuery(name = "CommodityMarketFormula.findByLowBidFormulaNum", query = "SELECT c FROM CommodityMarketFormula c WHERE c.lowBidFormulaNum = :lowBidFormulaNum"), @NamedQuery(name = "CommodityMarketFormula.findByHighAskedFormulaNum", query = "SELECT c FROM CommodityMarketFormula c WHERE c.highAskedFormulaNum = :highAskedFormulaNum"), @NamedQuery(name = "CommodityMarketFormula.findByAvgClosedFormulaNum", query = "SELECT c FROM CommodityMarketFormula c WHERE c.avgClosedFormulaNum = :avgClosedFormulaNum"), @NamedQuery(name = "CommodityMarketFormula.findByLowBidSimpleFormulaNum", query = "SELECT c FROM CommodityMarketFormula c WHERE c.lowBidSimpleFormulaNum = :lowBidSimpleFormulaNum"), @NamedQuery(name = "CommodityMarketFormula.findByHighAskedSimpleFormulaNum", query = "SELECT c FROM CommodityMarketFormula c WHERE c.highAskedSimpleFormulaNum = :highAskedSimpleFormulaNum"), @NamedQuery(name = "CommodityMarketFormula.findByAvgClosedSimpleFormulaNum", query = "SELECT c FROM CommodityMarketFormula c WHERE c.avgClosedSimpleFormulaNum = :avgClosedSimpleFormulaNum"), @NamedQuery(name = "CommodityMarketFormula.findByCmfNum", query = "SELECT c FROM CommodityMarketFormula c WHERE c.cmfNum = :cmfNum"), @NamedQuery(name = "CommodityMarketFormula.findByMptNum", query = "SELECT c FROM CommodityMarketFormula c WHERE c.mptNum = :mptNum"), @NamedQuery(name = "CommodityMarketFormula.findByTransId", query = "SELECT c FROM CommodityMarketFormula c WHERE c.transId = :transId")})
public class CommodityMarketFormula implements Serializable
{
	...
	@JoinColumns({@JoinColumn(name = "commkt_key", referencedColumnName = "commkt_key", insertable = false, updatable = false), @JoinColumn(name = "trading_prd", referencedColumnName = "trading_prd", insertable = false, updatable = false)})
	@ManyToOne(optional = false)
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityMarketFormula)){ return false; }
		CommodityMarketFormula other = (CommodityMarketFormula) object;
		if((this.commodityMarketFormulaPK == null && other.commodityMarketFormulaPK != null) || (this.commodityMarketFormulaPK != null && !this.commodityMarketFormulaPK.equals(other.commodityMarketFormulaPK))){ return false; }
		return true;
	}

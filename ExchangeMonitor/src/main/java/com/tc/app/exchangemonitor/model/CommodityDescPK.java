...
public class CommodityDescPK implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityDescPK)){ return false; }
		...
		if((this.cmdtyDescLang == null && other.cmdtyDescLang != null) || (this.cmdtyDescLang != null && !this.cmdtyDescLang.equals(other.cmdtyDescLang))){ return false; }
		if((this.cmdtyDescFor == null && other.cmdtyDescFor != null) || (this.cmdtyDescFor != null && !this.cmdtyDescFor.equals(other.cmdtyDescFor))){ return false; }
		return true;
	}

...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommodityDesc.findAll", query = "SELECT c FROM CommodityDesc c"), @NamedQuery(name = "CommodityDesc.findByCmdtyCode", query = "SELECT c FROM CommodityDesc c WHERE c.commodityDescPK.cmdtyCode = :cmdtyCode"), @NamedQuery(name = "CommodityDesc.findByCmdtyDescLang", query = "SELECT c FROM CommodityDesc c WHERE c.commodityDescPK.cmdtyDescLang = :cmdtyDescLang"), @NamedQuery(name = "CommodityDesc.findByCmdtyDescFor", query = "SELECT c FROM CommodityDesc c WHERE c.commodityDescPK.cmdtyDescFor = :cmdtyDescFor"), @NamedQuery(name = "CommodityDesc.findByCmdtyDesc", query = "SELECT c FROM CommodityDesc c WHERE c.cmdtyDesc = :cmdtyDesc"), @NamedQuery(name = "CommodityDesc.findByTransId", query = "SELECT c FROM CommodityDesc c WHERE c.transId = :transId")})
public class CommodityDesc implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityDesc)){ return false; }
		CommodityDesc other = (CommodityDesc) object;
		if((this.commodityDescPK == null && other.commodityDescPK != null) || (this.commodityDescPK != null && !this.commodityDescPK.equals(other.commodityDescPK))){ return false; }
		return true;
	}

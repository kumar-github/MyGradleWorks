...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommodityUom.findAll", query = "SELECT c FROM CommodityUom c"), @NamedQuery(name = "CommodityUom.findByCmdtyCode", query = "SELECT c FROM CommodityUom c WHERE c.commodityUomPK.cmdtyCode = :cmdtyCode"), @NamedQuery(name = "CommodityUom.findByCmdtyUomFor", query = "SELECT c FROM CommodityUom c WHERE c.commodityUomPK.cmdtyUomFor = :cmdtyUomFor"), @NamedQuery(name = "CommodityUom.findByUomCode", query = "SELECT c FROM CommodityUom c WHERE c.commodityUomPK.uomCode = :uomCode"), @NamedQuery(name = "CommodityUom.findByTransId", query = "SELECT c FROM CommodityUom c WHERE c.transId = :transId")})
public class CommodityUom implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityUom)){ return false; }
		CommodityUom other = (CommodityUom) object;
		if((this.commodityUomPK == null && other.commodityUomPK != null) || (this.commodityUomPK != null && !this.commodityUomPK.equals(other.commodityUomPK))){ return false; }
		return true;
	}

...
public class CommodityRollupHierarchyPK implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityRollupHierarchyPK)){ return false; }
		CommodityRollupHierarchyPK other = (CommodityRollupHierarchyPK) object;
		if((this.parentCmdtyCode == null && other.parentCmdtyCode != null) || (this.parentCmdtyCode != null && !this.parentCmdtyCode.equals(other.parentCmdtyCode))){ return false; }

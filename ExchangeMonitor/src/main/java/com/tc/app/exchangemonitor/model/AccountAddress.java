...
public class AccountAddress implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof AccountAddress)){ return false; }
		AccountAddress other = (AccountAddress) object;
		if((this.accountAddressPK == null && other.accountAddressPK != null) || (this.accountAddressPK != null && !this.accountAddressPK.equals(other.accountAddressPK))){ return false; }
		return true;
	}

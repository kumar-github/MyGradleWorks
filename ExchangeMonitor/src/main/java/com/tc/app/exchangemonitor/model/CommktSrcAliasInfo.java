...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommktSrcAliasInfo.findAll", query = "SELECT c FROM CommktSrcAliasInfo c"), @NamedQuery(name = "CommktSrcAliasInfo.findByCommktKey", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.commktSrcAliasInfoPK.commktKey = :commktKey"), @NamedQuery(name = "CommktSrcAliasInfo.findByPriceSourceCode", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.commktSrcAliasInfoPK.priceSourceCode = :priceSourceCode"), @NamedQuery(name = "CommktSrcAliasInfo.findByAliasSourceCode", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.commktSrcAliasInfoPK.aliasSourceCode = :aliasSourceCode"), @NamedQuery(name = "CommktSrcAliasInfo.findByCalcAvgPriceInd", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.calcAvgPriceInd = :calcAvgPriceInd"), @NamedQuery(name = "CommktSrcAliasInfo.findByPriceLoadStart", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.priceLoadStart = :priceLoadStart"), @NamedQuery(name = "CommktSrcAliasInfo.findByPriceLoadFreq", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.priceLoadFreq = :priceLoadFreq"), @NamedQuery(name = "CommktSrcAliasInfo.findByPriceLoadDuration", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.priceLoadDuration = :priceLoadDuration"), @NamedQuery(name = "CommktSrcAliasInfo.findByCommktGenerateSpotInd", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.commktGenerateSpotInd = :commktGenerateSpotInd"), @NamedQuery(name = "CommktSrcAliasInfo.findByCommktCodedAsSpotInd", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.commktCodedAsSpotInd = :commktCodedAsSpotInd"), @NamedQuery(name = "CommktSrcAliasInfo.findByTransId", query = "SELECT c FROM CommktSrcAliasInfo c WHERE c.transId = :transId")})
public class CommktSrcAliasInfo implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommktSrcAliasInfo)){ return false; }
		CommktSrcAliasInfo other = (CommktSrcAliasInfo) object;
		if((this.commktSrcAliasInfoPK == null && other.commktSrcAliasInfoPK != null) || (this.commktSrcAliasInfoPK != null && !this.commktSrcAliasInfoPK.equals(other.commktSrcAliasInfoPK))){ return false; }
		return true;
	}

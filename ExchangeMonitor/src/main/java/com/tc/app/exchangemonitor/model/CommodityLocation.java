...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommodityLocation.findAll", query = "SELECT c FROM CommodityLocation c"), @NamedQuery(name = "CommodityLocation.findByCmdtyCode", query = "SELECT c FROM CommodityLocation c WHERE c.commodityLocationPK.cmdtyCode = :cmdtyCode"), @NamedQuery(name = "CommodityLocation.findByLocCode", query = "SELECT c FROM CommodityLocation c WHERE c.commodityLocationPK.locCode = :locCode"), @NamedQuery(name = "CommodityLocation.findByTypicalGravity", query = "SELECT c FROM CommodityLocation c WHERE c.typicalGravity = :typicalGravity"), @NamedQuery(name = "CommodityLocation.findByTransId", query = "SELECT c FROM CommodityLocation c WHERE c.transId = :transId")})
public class CommodityLocation implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityLocation)){ return false; }
		CommodityLocation other = (CommodityLocation) object;
		if((this.commodityLocationPK == null && other.commodityLocationPK != null) || (this.commodityLocationPK != null && !this.commodityLocationPK.equals(other.commodityLocationPK))){ return false; }
		return true;
	}

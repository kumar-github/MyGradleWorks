...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "Country.findAll", query = "SELECT c FROM Country c"), @NamedQuery(name = "Country.findByCountryCode", query = "SELECT c FROM Country c WHERE c.countryCode = :countryCode"), @NamedQuery(name = "Country.findByCountryName", query = "SELECT c FROM Country c WHERE c.countryName = :countryName"), @NamedQuery(name = "Country.findByNoBusInd", query = "SELECT c FROM Country c WHERE c.noBusInd = :noBusInd"), @NamedQuery(name = "Country.findByCountryNum", query = "SELECT c FROM Country c WHERE c.countryNum = :countryNum"), @NamedQuery(name = "Country.findByCountryStatus", query = "SELECT c FROM Country c WHERE c.countryStatus = :countryStatus"), @NamedQuery(name = "Country.findByIntCurrCode", query = "SELECT c FROM Country c WHERE c.intCurrCode = :intCurrCode"), @NamedQuery(name = "Country.findByExtCurrCode", query = "SELECT c FROM Country c WHERE c.extCurrCode = :extCurrCode"), @NamedQuery(name = "Country.findByCountryLimitAmt", query = "SELECT c FROM Country c WHERE c.countryLimitAmt = :countryLimitAmt"), @NamedQuery(name = "Country.findByCountryLimitUtilAmt", query = "SELECT c FROM Country c WHERE c.countryLimitUtilAmt = :countryLimitUtilAmt"), @NamedQuery(name = "Country.findByCmntNum", query = "SELECT c FROM Country c WHERE c.cmntNum = :cmntNum"), @NamedQuery(name = "Country.findByExposurePriorityCode", query = "SELECT c FROM Country c WHERE c.exposurePriorityCode = :exposurePriorityCode"), @NamedQuery(name = "Country.findByTransId", query = "SELECT c FROM Country c WHERE c.transId = :transId"), @NamedQuery(name = "Country.findByIsoCountryCode", query = "SELECT c FROM Country c WHERE c.isoCountryCode = :isoCountryCode")})
public class Country implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if((this.countryCode == null && other.countryCode != null) || (this.countryCode != null && !this.countryCode.equals(other.countryCode))){ return false; }
		return true;
	}

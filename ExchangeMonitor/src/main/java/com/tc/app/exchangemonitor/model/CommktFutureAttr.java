...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommktFutureAttr.findAll", query = "SELECT c FROM CommktFutureAttr c"), @NamedQuery(name = "CommktFutureAttr.findByCommktKey", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktKey = :commktKey"), @NamedQuery(name = "CommktFutureAttr.findByCommktFutAttrStatus", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktFutAttrStatus = :commktFutAttrStatus"), @NamedQuery(name = "CommktFutureAttr.findByCommktLotSize", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktLotSize = :commktLotSize"), @NamedQuery(name = "CommktFutureAttr.findByCommktSettlementInd", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktSettlementInd = :commktSettlementInd"), @NamedQuery(name = "CommktFutureAttr.findByCommktPriceFmt", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktPriceFmt = :commktPriceFmt"), @NamedQuery(name = "CommktFutureAttr.findByCommktTradingMthInd", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktTradingMthInd = :commktTradingMthInd"), @NamedQuery(name = "CommktFutureAttr.findByCommktNearbyMask", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktNearbyMask = :commktNearbyMask"), @NamedQuery(name = "CommktFutureAttr.findByCommktMinPriceVar", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktMinPriceVar = :commktMinPriceVar"), @NamedQuery(name = "CommktFutureAttr.findByCommktMaxPriceVar", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktMaxPriceVar = :commktMaxPriceVar"), @NamedQuery(name = "CommktFutureAttr.findByCommktSpotPrd", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktSpotPrd = :commktSpotPrd"), @NamedQuery(name = "CommktFutureAttr.findByCommktPriceFreq", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktPriceFreq = :commktPriceFreq"), @NamedQuery(name = "CommktFutureAttr.findByCommktPriceFreqAsOf", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktPriceFreqAsOf = :commktPriceFreqAsOf"), @NamedQuery(name = "CommktFutureAttr.findByCommktPriceSeries", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktPriceSeries = :commktPriceSeries"), @NamedQuery(name = "CommktFutureAttr.findByCommktSpotMthQty", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktSpotMthQty = :commktSpotMthQty"), @NamedQuery(name = "CommktFutureAttr.findByCommktFwdMthQty", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktFwdMthQty = :commktFwdMthQty"), @NamedQuery(name = "CommktFutureAttr.findByCommktTotalOpenQty", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktTotalOpenQty = :commktTotalOpenQty"), @NamedQuery(name = "CommktFutureAttr.findByCommktFormulaType", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktFormulaType = :commktFormulaType"), @NamedQuery(name = "CommktFutureAttr.findByCommktInterpolType", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktInterpolType = :commktInterpolType"), @NamedQuery(name = "CommktFutureAttr.findByCommktNumMthOut", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktNumMthOut = :commktNumMthOut"), @NamedQuery(name = "CommktFutureAttr.findByCommktSupportPriceType", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktSupportPriceType = :commktSupportPriceType"), @NamedQuery(name = "CommktFutureAttr.findByCommktSameAsMktCode", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktSameAsMktCode = :commktSameAsMktCode"), @NamedQuery(name = "CommktFutureAttr.findByCommktSameAsCmdtyCode", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktSameAsCmdtyCode = :commktSameAsCmdtyCode"), @NamedQuery(name = "CommktFutureAttr.findByCommktForexMktCode", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktForexMktCode = :commktForexMktCode"), @NamedQuery(name = "CommktFutureAttr.findByCommktForexCmdtyCode", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktForexCmdtyCode = :commktForexCmdtyCode"), @NamedQuery(name = "CommktFutureAttr.findByCommktPriceDivMulInd", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktPriceDivMulInd = :commktPriceDivMulInd"), @NamedQuery(name = "CommktFutureAttr.findByCommktLimitMoveInd", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktLimitMoveInd = :commktLimitMoveInd"), @NamedQuery(name = "CommktFutureAttr.findByCommktPointConvNum", query = "SELECT c FROM CommktFutureAttr c WHERE c.commktPointConvNum = :commktPointConvNum"), @NamedQuery(name = "CommktFutureAttr.findByTransId", query = "SELECT c FROM CommktFutureAttr c WHERE c.transId = :transId")})
public class CommktFutureAttr implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommktFutureAttr)){ return false; }

...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommktPhysicalAttr.findAll", query = "SELECT c FROM CommktPhysicalAttr c"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktKey", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktKey = :commktKey"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktPhyAttrStatus", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktPhyAttrStatus = :commktPhyAttrStatus"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktDfltQty", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktDfltQty = :commktDfltQty"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktQtyUomCode", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktQtyUomCode = :commktQtyUomCode"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktPriceFmt", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktPriceFmt = :commktPriceFmt"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktMinPriceVar", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktMinPriceVar = :commktMinPriceVar"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktMaxPriceVar", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktMaxPriceVar = :commktMaxPriceVar"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktSpotPrd", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktSpotPrd = :commktSpotPrd"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktPriceFreq", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktPriceFreq = :commktPriceFreq"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktPriceFreqAsOf", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktPriceFreqAsOf = :commktPriceFreqAsOf"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktPriceSeries", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktPriceSeries = :commktPriceSeries"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktFormulaType", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktFormulaType = :commktFormulaType"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktInterpolType", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktInterpolType = :commktInterpolType"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktNumMthOut", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktNumMthOut = :commktNumMthOut"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktSupportPriceType", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktSupportPriceType = :commktSupportPriceType"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktSameAsMktCode", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktSameAsMktCode = :commktSameAsMktCode"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktSameAsCmdtyCode", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktSameAsCmdtyCode = :commktSameAsCmdtyCode"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktForexMktCode", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktForexMktCode = :commktForexMktCode"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktForexCmdtyCode", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktForexCmdtyCode = :commktForexCmdtyCode"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktPriceDivMulInd", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktPriceDivMulInd = :commktPriceDivMulInd"), @NamedQuery(name = "CommktPhysicalAttr.findByCommktPointConvNum", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.commktPointConvNum = :commktPointConvNum"), @NamedQuery(name = "CommktPhysicalAttr.findByTransId", query = "SELECT c FROM CommktPhysicalAttr c WHERE c.transId = :transId")})
public class CommktPhysicalAttr implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommktPhysicalAttr)){ return false; }

...
public class CommodityUomPK implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityUomPK)){ return false; }
		...
		if((this.cmdtyUomFor == null && other.cmdtyUomFor != null) || (this.cmdtyUomFor != null && !this.cmdtyUomFor.equals(other.cmdtyUomFor))){ return false; }

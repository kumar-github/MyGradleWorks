...
public class AccountContact implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof AccountContact)){ return false; }
		AccountContact other = (AccountContact) object;
		if((this.accountContactPK == null && other.accountContactPK != null) || (this.accountContactPK != null && !this.accountContactPK.equals(other.accountContactPK))){ return false; }
		return true;
	}

...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CreditTermGroup.findAll", query = "SELECT c FROM CreditTermGroup c"), @NamedQuery(name = "CreditTermGroup.findByGroupNum", query = "SELECT c FROM CreditTermGroup c WHERE c.creditTermGroupPK.groupNum = :groupNum"), @NamedQuery(name = "CreditTermGroup.findByCreditTermCode", query = "SELECT c FROM CreditTermGroup c WHERE c.creditTermGroupPK.creditTermCode = :creditTermCode"), @NamedQuery(name = "CreditTermGroup.findByTransId", query = "SELECT c FROM CreditTermGroup c WHERE c.transId = :transId")})
public class CreditTermGroup implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CreditTermGroup)){ return false; }
		CreditTermGroup other = (CreditTermGroup) object;
		if((this.creditTermGroupPK == null && other.creditTermGroupPK != null) || (this.creditTermGroupPK != null && !this.creditTermGroupPK.equals(other.creditTermGroupPK))){ return false; }
		return true;
	}

...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "ExternalPosition.findAll", query = "SELECT e FROM ExternalPosition e"), @NamedQuery(name = "ExternalPosition.findByExtPosNum", query = "SELECT e FROM ExternalPosition e WHERE e.extPosNum = :extPosNum"), @NamedQuery(name = "ExternalPosition.findByTradingPrd", query = "SELECT e FROM ExternalPosition e WHERE e.tradingPrd = :tradingPrd"), @NamedQuery(name = "ExternalPosition.findByItemType", query = "SELECT e FROM ExternalPosition e WHERE e.itemType = :itemType"), @NamedQuery(name = "ExternalPosition.findByPutCallInd", query = "SELECT e FROM ExternalPosition e WHERE e.putCallInd = :putCallInd"), @NamedQuery(name = "ExternalPosition.findByStrikePrice", query = "SELECT e FROM ExternalPosition e WHERE e.strikePrice = :strikePrice"), @NamedQuery(name = "ExternalPosition.findByQuantity", query = "SELECT e FROM ExternalPosition e WHERE e.quantity = :quantity"), @NamedQuery(name = "ExternalPosition.findByTransId", query = "SELECT e FROM ExternalPosition e WHERE e.transId = :transId")})
public class ExternalPosition implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof ExternalPosition)){ return false; }
		ExternalPosition other = (ExternalPosition) object;
		if((this.extPosNum == null && other.extPosNum != null) || (this.extPosNum != null && !this.extPosNum.equals(other.extPosNum))){ return false; }
		return true;
	}

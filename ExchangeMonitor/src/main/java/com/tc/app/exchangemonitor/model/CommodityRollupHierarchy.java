...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommodityRollupHierarchy.findAll", query = "SELECT c FROM CommodityRollupHierarchy c"), @NamedQuery(name = "CommodityRollupHierarchy.findByParentCmdtyCode", query = "SELECT c FROM CommodityRollupHierarchy c WHERE c.commodityRollupHierarchyPK.parentCmdtyCode = :parentCmdtyCode"), @NamedQuery(name = "CommodityRollupHierarchy.findByCmdtyCode", query = "SELECT c FROM CommodityRollupHierarchy c WHERE c.commodityRollupHierarchyPK.cmdtyCode = :cmdtyCode"), @NamedQuery(name = "CommodityRollupHierarchy.findByRollupTypeCode", query = "SELECT c FROM CommodityRollupHierarchy c WHERE c.commodityRollupHierarchyPK.rollupTypeCode = :rollupTypeCode"), @NamedQuery(name = "CommodityRollupHierarchy.findByTransId", query = "SELECT c FROM CommodityRollupHierarchy c WHERE c.transId = :transId")})
public class CommodityRollupHierarchy implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityRollupHierarchy)){ return false; }
		CommodityRollupHierarchy other = (CommodityRollupHierarchy) object;
		if((this.commodityRollupHierarchyPK == null && other.commodityRollupHierarchyPK != null) || (this.commodityRollupHierarchyPK != null && !this.commodityRollupHierarchyPK.equals(other.commodityRollupHierarchyPK))){ return false; }
		return true;
	}

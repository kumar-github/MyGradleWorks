...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommodityGroup.findAll", query = "SELECT c FROM CommodityGroup c"), @NamedQuery(name = "CommodityGroup.findByParentCmdtyCode", query = "SELECT c FROM CommodityGroup c WHERE c.commodityGroupPK.parentCmdtyCode = :parentCmdtyCode"), @NamedQuery(name = "CommodityGroup.findByCmdtyCode", query = "SELECT c FROM CommodityGroup c WHERE c.commodityGroupPK.cmdtyCode = :cmdtyCode"), @NamedQuery(name = "CommodityGroup.findByCmdtyGroupTypeCode", query = "SELECT c FROM CommodityGroup c WHERE c.commodityGroupPK.cmdtyGroupTypeCode = :cmdtyGroupTypeCode"), @NamedQuery(name = "CommodityGroup.findByTransId", query = "SELECT c FROM CommodityGroup c WHERE c.transId = :transId")})
public class CommodityGroup implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityGroup)){ return false; }
		CommodityGroup other = (CommodityGroup) object;
		if((this.commodityGroupPK == null && other.commodityGroupPK != null) || (this.commodityGroupPK != null && !this.commodityGroupPK.equals(other.commodityGroupPK))){ return false; }
		return true;
	}

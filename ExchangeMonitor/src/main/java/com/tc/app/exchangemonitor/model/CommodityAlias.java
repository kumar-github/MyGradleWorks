...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommodityAlias.findAll", query = "SELECT c FROM CommodityAlias c"), @NamedQuery(name = "CommodityAlias.findByCmdtyCode", query = "SELECT c FROM CommodityAlias c WHERE c.commodityAliasPK.cmdtyCode = :cmdtyCode"), @NamedQuery(name = "CommodityAlias.findByAliasSourceCode", query = "SELECT c FROM CommodityAlias c WHERE c.commodityAliasPK.aliasSourceCode = :aliasSourceCode"), @NamedQuery(name = "CommodityAlias.findByCmdtyAliasName", query = "SELECT c FROM CommodityAlias c WHERE c.cmdtyAliasName = :cmdtyAliasName"), @NamedQuery(name = "CommodityAlias.findByTransId", query = "SELECT c FROM CommodityAlias c WHERE c.transId = :transId")})
public class CommodityAlias implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityAlias)){ return false; }
		CommodityAlias other = (CommodityAlias) object;
		if((this.commodityAliasPK == null && other.commodityAliasPK != null) || (this.commodityAliasPK != null && !this.commodityAliasPK.equals(other.commodityAliasPK))){ return false; }
		return true;
	}

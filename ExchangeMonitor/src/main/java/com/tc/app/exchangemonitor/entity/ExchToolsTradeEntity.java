...
public class ExchToolsTradeEntity implements IExchToolsTradeEntity
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof ExchToolsTrade)){ return false; }
		ExchToolsTrade other = (ExchToolsTrade) object;
		if((this.getExternalTradeOid() == null && other.getExternalTradeOid() != null) || (this.getExternalTradeOid() != null && !this.getExternalTradeOid().equals(other.getExternalTradeOid()))){ return false; }
		return true;
	}

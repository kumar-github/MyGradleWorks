...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommodityMarketSource.findAll", query = "SELECT c FROM CommodityMarketSource c"), @NamedQuery(name = "CommodityMarketSource.findByCommktKey", query = "SELECT c FROM CommodityMarketSource c WHERE c.commodityMarketSourcePK.commktKey = :commktKey"), @NamedQuery(name = "CommodityMarketSource.findByPriceSourceCode", query = "SELECT c FROM CommodityMarketSource c WHERE c.commodityMarketSourcePK.priceSourceCode = :priceSourceCode"), @NamedQuery(name = "CommodityMarketSource.findByTvmUseInd", query = "SELECT c FROM CommodityMarketSource c WHERE c.tvmUseInd = :tvmUseInd"), @NamedQuery(name = "CommodityMarketSource.findByOptionEvalUseInd", query = "SELECT c FROM CommodityMarketSource c WHERE c.optionEvalUseInd = :optionEvalUseInd"), @NamedQuery(name = "CommodityMarketSource.findByFinancialBorrowUseInd", query = "SELECT c FROM CommodityMarketSource c WHERE c.financialBorrowUseInd = :financialBorrowUseInd"), @NamedQuery(name = "CommodityMarketSource.findByFinancialLendUseInd", query = "SELECT c FROM CommodityMarketSource c WHERE c.financialLendUseInd = :financialLendUseInd"), @NamedQuery(name = "CommodityMarketSource.findByQuotePricePrecision", query = "SELECT c FROM CommodityMarketSource c WHERE c.quotePricePrecision = :quotePricePrecision"), @NamedQuery(name = "CommodityMarketSource.findByTransId", query = "SELECT c FROM CommodityMarketSource c WHERE c.transId = :transId")})
public class CommodityMarketSource implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommodityMarketSource)){ return false; }
		CommodityMarketSource other = (CommodityMarketSource) object;
		if((this.commodityMarketSourcePK == null && other.commodityMarketSourcePK != null) || (this.commodityMarketSourcePK != null && !this.commodityMarketSourcePK.equals(other.commodityMarketSourcePK))){ return false; }
		return true;
	}

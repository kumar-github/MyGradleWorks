...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "CommktOptionAttr.findAll", query = "SELECT c FROM CommktOptionAttr c"), @NamedQuery(name = "CommktOptionAttr.findByCommktKey", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktKey = :commktKey"), @NamedQuery(name = "CommktOptionAttr.findByCommktOptAttrStatus", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktOptAttrStatus = :commktOptAttrStatus"), @NamedQuery(name = "CommktOptionAttr.findByCommktLotSize", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktLotSize = :commktLotSize"), @NamedQuery(name = "CommktOptionAttr.findByCommktSettlementInd", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktSettlementInd = :commktSettlementInd"), @NamedQuery(name = "CommktOptionAttr.findByCommktPriceFmt", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktPriceFmt = :commktPriceFmt"), @NamedQuery(name = "CommktOptionAttr.findByCommktTradingMthInd", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktTradingMthInd = :commktTradingMthInd"), @NamedQuery(name = "CommktOptionAttr.findByCommktNearbyMask", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktNearbyMask = :commktNearbyMask"), @NamedQuery(name = "CommktOptionAttr.findByCommktMinPriceVar", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktMinPriceVar = :commktMinPriceVar"), @NamedQuery(name = "CommktOptionAttr.findByCommktMaxPriceVar", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktMaxPriceVar = :commktMaxPriceVar"), @NamedQuery(name = "CommktOptionAttr.findByCommktSpotPrd", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktSpotPrd = :commktSpotPrd"), @NamedQuery(name = "CommktOptionAttr.findByCommktPriceFreq", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktPriceFreq = :commktPriceFreq"), @NamedQuery(name = "CommktOptionAttr.findByCommktPriceFreqAsOf", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktPriceFreqAsOf = :commktPriceFreqAsOf"), @NamedQuery(name = "CommktOptionAttr.findByCommktPriceSeries", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktPriceSeries = :commktPriceSeries"), @NamedQuery(name = "CommktOptionAttr.findByCommktSpotMthQty", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktSpotMthQty = :commktSpotMthQty"), @NamedQuery(name = "CommktOptionAttr.findByCommktFwdMthQty", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktFwdMthQty = :commktFwdMthQty"), @NamedQuery(name = "CommktOptionAttr.findByCommktTotalOpenQty", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktTotalOpenQty = :commktTotalOpenQty"), @NamedQuery(name = "CommktOptionAttr.findByCommktOptType", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktOptType = :commktOptType"), @NamedQuery(name = "CommktOptionAttr.findByCommktOptExpTime", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktOptExpTime = :commktOptExpTime"), @NamedQuery(name = "CommktOptionAttr.findByCommktOptExpZone", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktOptExpZone = :commktOptExpZone"), @NamedQuery(name = "CommktOptionAttr.findByCommktFormulaType", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktFormulaType = :commktFormulaType"), @NamedQuery(name = "CommktOptionAttr.findByCommktInterpolType", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktInterpolType = :commktInterpolType"), @NamedQuery(name = "CommktOptionAttr.findByCommktNumMthOut", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktNumMthOut = :commktNumMthOut"), @NamedQuery(name = "CommktOptionAttr.findByCommktSupportPriceType", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktSupportPriceType = :commktSupportPriceType"), @NamedQuery(name = "CommktOptionAttr.findByCommktSameAsMktCode", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktSameAsMktCode = :commktSameAsMktCode"), @NamedQuery(name = "CommktOptionAttr.findByCommktSameAsCmdtyCode", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktSameAsCmdtyCode = :commktSameAsCmdtyCode"), @NamedQuery(name = "CommktOptionAttr.findByCommktForexMktCode", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktForexMktCode = :commktForexMktCode"), @NamedQuery(name = "CommktOptionAttr.findByCommktForexCmdtyCode", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktForexCmdtyCode = :commktForexCmdtyCode"), @NamedQuery(name = "CommktOptionAttr.findByCommktPriceDivMulInd", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktPriceDivMulInd = :commktPriceDivMulInd"), @NamedQuery(name = "CommktOptionAttr.findByCommktPointConvNum", query = "SELECT c FROM CommktOptionAttr c WHERE c.commktPointConvNum = :commktPointConvNum"), @NamedQuery(name = "CommktOptionAttr.findByTransId", query = "SELECT c FROM CommktOptionAttr c WHERE c.transId = :transId"), @NamedQuery(name = "CommktOptionAttr.findByMarginType", query = "SELECT c FROM CommktOptionAttr c WHERE c.marginType = :marginType")})
public class CommktOptionAttr implements Serializable
{
	...
	public boolean equals(Object object)
	{
		...
		if(!(object instanceof CommktOptionAttr)){ return false; }
